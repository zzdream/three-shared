...
export const FBX_URL: any = {
  ...
  cally: people + 'people1.fbx',
  小孩: people + 'Child.fbx',
  狗: people + 'dog.fbx',
  窨井盖: object + 'Manhole_cover.fbx',
  'RSU-1': object + 'RSU_1.fbx',
  'RSU-2': object + 'RSU_2.fbx',
  三角警示架: object + 'WarningTriangle.fbx',
  水马防撞桶: object + 'water_tong.fbx',
  箱子: object + 'Box.fbx',
  水马围挡: object + 'water_weilan.fbx',
  树枝: object + 'TreeBranch.fbx',
  '轮胎-竖': object + 'Wheel_colum.fbx',
  '轮胎-横': object + 'Wheel_row.fbx',
  UWB基站: object + 'UWB.fbx',
  水马: object + 'water_shuima.fbx',
  护栏: object + 'Guardrail.fbx',
  前方道路施工标志牌: object + 'RoadWorkSign.fbx',
  井盖_开: object + 'Manhole_cover_open.fbx',
  路面坑洼: object + 'Pothole.fbx',
  路面凸起: object + 'Road_hump.fbx',
  积水坑: object + 'Water_filled.fbx',
  积雪堆: object + 'Snowdrift.fbx',
  车辙印: object + 'Wheel_track.fbx',
  裂缝: object + 'Crack.fbx',
}
const vehicle_glb = '/models1/vehicle/'
const people_glb = '/models1/people/'
const object_glb = '/models1/object/'
export const GLB_URL: any = {
  默认: vehicle_glb + 'default.glb',
  '默认 黑色': vehicle_glb + 'default_black.glb',
  '默认 白色': vehicle_glb + 'default_white.glb',
  '默认 红色': vehicle_glb + 'default_red.glb',
  摩托车: vehicle_glb + 'Motorcycle.glb',
  自行车: vehicle_glb + 'bike.glb',
  骑行者: vehicle_glb + 'rider.glb',
  两轮电动车: vehicle_glb + 'BEV.glb',
  三轮车: vehicle_glb + 'tricycle.glb',
  '哈弗 H6': vehicle_glb + 'HAVAL_H6.glb',
  '奥迪 A3 2.0T': vehicle_glb + 'A3_20T.glb',
  '奥迪 A3 两厢版': vehicle_glb + 'A3.glb',
  '奥迪 A3 1.4T': vehicle_glb + 'A3_14T.glb',
  '奥迪 Q3': vehicle_glb + 'Q3.glb',
  '大众 宝来': vehicle_glb + 'Bora.glb',
  '大众 高尔夫': vehicle_glb + 'GOLF.glb',
  '大众 高尔夫嘉旅': vehicle_glb + 'GOLF_Sportsvan.glb',
  '大众 迈腾': vehicle_glb + 'MAGOTAN.glb',
  '大众 帕萨特': vehicle_glb + 'PASSAT.glb',
  '大众 速腾': vehicle_glb + 'Sagitar.glb',
  '大众 探岳': vehicle_glb + 'TAYRON.glb',
  '大众 途昂': vehicle_glb + 'Teramont.glb',
  '大众 途观': vehicle_glb + 'Tiguan.glb',
  '大众 捷达': vehicle_glb + 'Jetta.glb',
  '吉利 博瑞': vehicle_glb + 'Borui.glb',
  '斯柯达 科迪亚克': vehicle_glb + 'Kodiaq.glb',
  '斯柯达 明锐': vehicle_glb + 'Octavia.glb',
  '斯柯达 速派': vehicle_glb + 'Superb.glb',
  '一汽 红旗': vehicle_glb + 'Hongqi.glb',
  '一汽 红旗 蓝色': vehicle_glb + 'Hongqi_blue.glb',
  '一汽 红旗 黑色': vehicle_glb + 'Hongqi_black.glb',
  '一汽 红旗 白色': vehicle_glb + 'Hongqi_white.glb',
  '一汽 红旗 红色': vehicle_glb + 'Hongqi_red.glb',
  '小米 SU7 蓝色': vehicle_glb + 'SU7_blue.glb',
  '小米 SU7 灰色': vehicle_glb + 'SU7_Gray.glb',
  '小米 SU7 橘色': vehicle_glb + 'SU7_origin.glb',
  '小米 SU7 紫色': vehicle_glb + 'SU7_pink.glb',
  MPV: vehicle_glb + 'MPV.glb',
  警车: vehicle_glb + 'policeCar.glb',
  公交车: vehicle_glb + 'Gongjiao.glb',
  卡车: vehicle_glb + 'Kache.glb',
  农用车: vehicle_glb + 'Nongyongche.glb',
  消防车: vehicle_glb + 'FireTruck.glb',
  救护车: vehicle_glb + 'Ambulance.glb',
  校车: vehicle_glb + 'SchoolBus.glb',
  other: vehicle_glb + 'default.glb',
  cally: people_glb + 'people1.glb',
  小孩: people_glb + 'Child.glb',
  狗: people_glb + 'dog.glb',
  窨井盖: object_glb + 'Manhole_cover.glb',
  'RSU-1': object_glb + 'RSU_1.glb',
  'RSU-2': object_glb + 'RSU_2.glb',
  三角警示架: object_glb + 'WarningTriangle.glb',
  水马防撞桶: object_glb + 'water_tong.glb',
  箱子: object_glb + 'Box.glb',
  水马围挡: object_glb + 'water_weilan.glb',
  树枝: object_glb + 'TreeBranch.glb',
  '轮胎-竖': object_glb + 'Wheel_colum.glb',
  '轮胎-横': object_glb + 'Wheel_row.glb',
  UWB基站: object_glb + 'UWB.glb',
  水马: object_glb + 'water_shuima.glb',
  护栏: object_glb + 'Guardrail.glb',
  前方道路施工标志牌: object_glb + 'RoadWorkSign.glb',
  井盖_开: object_glb + 'Manhole_cover_open.glb',
  路面坑洼: object_glb + 'Pothole.glb',
  路面凸起: object_glb + 'Road_hump.glb',
  积水坑: object_glb + 'Water_filled.glb',
  积雪堆: object_glb + 'Snowdrift.glb',
  车辙印: object_glb + 'Wheel_track.glb',
  裂缝: object_glb + 'Crack.glb',
}