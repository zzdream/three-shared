...
export const MODAL_TO_URL: any = {
  ...
  // ----------------------------------------------------------------------------------------------车模 45个
  默认: vehicle + 'default.FBX',
  '默认 黑色': vehicle + 'default_black.FBX',
  '默认 白色': vehicle + 'default_white.FBX',
  '默认 红色': vehicle + 'default_red.FBX',
  摩托车: vehicle + 'Motorcycle.FBX',
  自行车: vehicle + 'bike.FBX',
  骑行者: vehicle + 'rider.FBX',
  两轮电动车: vehicle + 'BEV.FBX',
  三轮车: vehicle + 'tricycle.FBX',
  '哈弗 H6': vehicle + 'HAVAL_H6.FBX',
  '奥迪 A3 2.0T': vehicle + 'A3_20T.FBX',
  '奥迪 A3 两厢版': vehicle + 'A3.FBX',
  '奥迪 A3 1.4T': vehicle + 'A3_14T.FBX',
  '奥迪 Q3': vehicle + 'Q3.FBX',
  '大众 宝来': vehicle + 'Bora.FBX',
  '大众 高尔夫': vehicle + 'GOLF.FBX',
  '大众 高尔夫嘉旅': vehicle + 'GOLF_Sportsvan.FBX',
  '大众 迈腾': vehicle + 'MAGOTAN.FBX',
  '大众 帕萨特': vehicle + 'PASSAT.FBX',
  '大众 速腾': vehicle + 'Sagitar.FBX',
  '大众 探岳': vehicle + 'TAYRON.FBX',
  '大众 途昂': vehicle + 'Teramont.FBX',
  '大众 途观': vehicle + 'Tiguan.FBX',
  '大众 捷达': vehicle + 'Jetta.FBX',
  '吉利 博瑞': vehicle + 'Borui.FBX',
  '斯柯达 科迪亚克': vehicle + 'Kodiaq.FBX',
  '斯柯达 明锐': vehicle + 'Octavia.FBX',
  '斯柯达 速派': vehicle + 'Superb.FBX',
  '一汽 红旗': vehicle + 'Hongqi.FBX',
  '一汽 红旗 蓝色': vehicle + 'Hongqi_blue.FBX',
  '一汽 红旗 黑色': vehicle + 'Hongqi_black.FBX',
  '一汽 红旗 白色': vehicle + 'Hongqi_white.FBX',
  '一汽 红旗 红色': vehicle + 'Hongqi_red.FBX',
  '小米 SU7 蓝色': vehicle + 'SU7_blue.FBX',
  'Xiaomi SU7 Blue': vehicle + 'SU7_blue.FBX',
  '小米 SU7 灰色': vehicle + 'SU7_Gray.FBX',
  'Xiaomi SU7 Gray': vehicle + 'SU7_Gray.FBX',
  '小米 SU7 橘色': vehicle + 'SU7_origin.FBX',
  'Xiaomi SU7 Orange': vehicle + 'SU7_origin.FBX',
  '小米 SU7 紫色': vehicle + 'SU7_pink.FBX',
  'Xiaomi SU7 Purple': vehicle + 'SU7_pink.FBX',
  MPV: vehicle + 'MPV.FBX',
  警车: vehicle + 'policeCar.FBX',
  公交车: vehicle + 'Gongjiao.FBX',
  卡车: vehicle + 'Kache.FBX',
  农用车: vehicle + 'Nongyongche.FBX',
  消防车: vehicle + 'FireTruck.FBX',
  救护车: vehicle + 'Ambulance.FBX',
  校车: vehicle + 'SchoolBus.FBX',
  other: vehicle + 'default.FBX',
  // ----------------------------------------------------------------------------------------------人模 3个
  cally: people + 'people1.FBX',
  小孩: people + 'Child.FBX',
  狗: people + 'dog.FBX',
  // ----------------------------------------------------------------------------------------------物模 22个
  交通锥: obj_model + 'Traffic_cone.fbx',
